...
(function() {
  var EventEmitter, IO, Thermometer, argv, config, emitSampleSignal, emitter, io, sample, sensor, sensorReading, sensors, shutdown, statsd, statsdClient, thermo, _i, _len;
