...
(function() {
  var EventEmitter, IO, Thermometer, argv, config, emitSampleSignal, emitter, end, io, mode, sample, send, sensor, sensorReading, sensors, shutdown, state, statsd, statsdClient, thermo, _i, _len;
