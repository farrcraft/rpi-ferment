...
(function() {
  var EventEmitter, IO, Thermometer, argv, config, emitSampleSignal, emitter, io, mode, sample, sensor, sensorReading, sensors, shutdown, state, statsd, statsdClient, thermo, _i, _len;
