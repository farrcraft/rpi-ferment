...
(function() {
  var EventEmitter, IO, Thermometer, argv, config, emitSampleSignal, emitter, end, io, mode, query, sample, send, sensor, sensorReading, sensors, shutdown, state, statsd, statsdClient, status, thermo, _i, _len;
