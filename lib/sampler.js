...
(function() {
  ...
  Sampler = (function(_super) {
    ...
    Sampler.prototype.controller_ = null;
    ...
    function Sampler(frequency, sensors, units, controller) {
      this.scheduleSample = __bind(this.scheduleSample, this);
      this.sample = __bind(this.sample, this);
      this.emitSampleSignal = __bind(this.emitSampleSignal, this);      this.sensors_ = sensors;
    ...
    Sampler.prototype.sample = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        this.controller_.processSample(sensor.name(sensorReading));
      }
      if (!this.shutdown_) {
        this.scheduleSample();
      }
