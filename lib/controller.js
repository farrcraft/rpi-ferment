...
(function() {
  ...
  Controller = (function() {
    ...
    Controller.prototype.checkSensorProfile = function(sensor) {
      var activeStep, now, override, profileStart, step, stepEnd, _i, _len, _ref;
      ...
      if (profileStart === void 0) {
        ...
        this.state_[sensor].profile.save();
      }
      ...
      if (this.state_[sensor].profile.overrides.length > 0) {
        if (this.state_[sensor].overrides[this.state_[sensor].profile.overrides.length - 1].action !== 'resume') {
          override = true;
        }
      }
